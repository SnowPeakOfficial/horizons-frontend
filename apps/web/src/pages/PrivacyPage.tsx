        ...
        <div style={{ maxWidth: '760px', margin: '0 auto', padding: '48px 24px 64px' }}>
          ...
          <div style={{ background: '#FFFFFF', borderRadius: '20px', padding: '40px', border: '1.5px solid rgba(232, 180, 184, 0.3)', boxShadow: '0 4px 20px rgba(212, 144, 154, 0.08)' }}>
            ...
            <Section title="11. Contact Us">
              <p>If you have any questions or concerns about this Privacy Policy, please contact us at <strong>privacy@horizons.app</strong> or use our <span style={{ color: '#D4909A', cursor: 'pointer' }} onClick={() => window.location.href = '/contact'}>Contact page</span>.</p>
            </Section>
          </div>
        </div>
      </div>
